...
XCVAR_DEF( g_teamSwitchTime,			"5",			NULL,				CVAR_ARCHIVE,									qfalse )	//how long to wait before switching teams is allowed (in seconds)
XCVAR_DEF( g_teamsLocked,				"0",			NULL,				CVAR_ARCHIVE,									qfalse )	//teams are locked after 20% of timelimit has passed (new players are allowed to switch teams for 3 mins)
